...
void test_cx_hash() {
  //----------------------------------------------------------------------------
  // FNV1 / FNV1A
  static_assert(cx::fnv1("hello, world") == 733686394982303293ull, "fnv1(\"hello, world\")");
  static_assert(cx::fnv1a("hello, world") == 1702823495152329533ull, "fnv1a(\"hello, world\")");

  //----------------------------------------------------------------------------
  // Murmur3
  static_assert(cx::murmur3_32("hello, world", 0) == 345750399, "murmur3(\"hello, world\")");
  static_assert(cx::murmur3_32("hello, world1", 0) == 3714214180, "murmur3(\"hello, world\")");
  static_assert(cx::murmur3_32("hello, world12", 0) == 83041023, "murmur3(\"hello, world\")");
  static_assert(cx::murmur3_32("hello, world123", 0) == 209220029, "murmur3(\"hello, world\")");
  static_assert(cx::murmur3_32("hello, world1234", 0) == 4241062699, "murmur3(\"hello, world\")");
  static_assert(cx::murmur3_32("hello, world", 1) == 1868346089, "murmur3(\"hello, world\")");
  ...
  //----------------------------------------------------------------------------
  // MD5
  constexpr cx::md5sum md5sums[8] = {{{0xd41d8cd9, 0x8f00b204, 0xe9800998, 0xecf8427e}},
  ...
  static_assert(
      cx::endianswap(cx::md5(testinputs[6]).h[0]) == md5sums[6].h[0]
  ...
  //----------------------------------------------------------------------------
  // SHA256
  constexpr cx::sha256sum sha256sums[8] = {{{0xe3b0c442, 0x98fc1c14, 0x9afbf4c8, 0x996fb924,
  ...
  static_assert(
      cx::endianswap(cx::sha256(testinputs[6]).h[0]) == sha256sums[6].h[0]
