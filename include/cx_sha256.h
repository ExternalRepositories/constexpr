    ...
    namespace sha256 {
      ...
      constexpr sha256sum sumadd(const sha256sum& s1, const sha256sum& s2) {
        return {{s1.h[0] + s2.h[0], s1.h[1] + s2.h[1], s1.h[2] + s2.h[2], s1.h[3] + s2.h[3],
                 s1.h[4] + s2.h[4], s1.h[5] + s2.h[5], s1.h[6] + s2.h[6], s1.h[7] + s2.h[7]}};
      }
      // initial sha256sum
      ...
      constexpr uint32_t temp1(const sha256sum& sum, int i) {
        return sum.h[7] + S1(sum.h[4]) + ch(sum.h[4], sum.h[5], sum.h[6]) + roundconst[i];
      }
      ...
      constexpr sha256sum rotateCR(const sha256sum& sum) {
        return {{sum.h[7], sum.h[0], sum.h[1], sum.h[2], sum.h[3], sum.h[4], sum.h[5], sum.h[6]}};
      }
      constexpr sha256sum rotateCL(const sha256sum& sum) {
        return {{sum.h[1], sum.h[2], sum.h[3], sum.h[4], sum.h[5], sum.h[6], sum.h[7], sum.h[0]}};
      }

      constexpr sha256sum sha256round(const sha256sum& sum, uint32_t t1, uint32_t t2) {
        return {
            {sum.h[0], sum.h[1], sum.h[2], sum.h[3] + t1, sum.h[4], sum.h[5], sum.h[6], t1 + t2}};
      }
      ...
      constexpr sha256sum sha256update(const sha256sum& sum, const char* msg, int len,
                                       int origlen) {
        return len >= 64
      ...
      constexpr sha256sum sha256(const char* msg) { return sha256withlen(msg, strlen(msg)); }
